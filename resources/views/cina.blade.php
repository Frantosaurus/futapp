...
<section>
    <div class="karty">
        ...
        <button class="karta" onclick="window.location.href='/cina/King_Sheng_Restaurant'">King Sheng
            Restaurant</button>
    </div>
    <div class="karty">
    ...
    <div class="karty">
        ...
        <button class="karta" onclick="window.location.href='/cina/Victory_Asia_Restaurant'">Victory Asia
            Restaurant</button>
