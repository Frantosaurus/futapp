...
<section>
    <div class="telo">
        <div class="nadpis col-auto">
            <h1>Potrefená Husa</h1>
        </div>
        <div class="row">
            <div class="col-sm">
                <div class="google-map">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d10312.832103373006!2d13.3777465!3d49.7445295!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x470af1e4936b0b8f%3A0x83b213d37bf5756d!2sRestaurace%20Potrefen%C3%A1%20Husa!5e0!3m2!1scs!2scz!4v1704807137159!5m2!1scs!2scz"
            ...
            <form action="{{ route('celamezipametToCacheAndSaveToDatabase') }}" method="POST">
                @csrf
                <input type="hidden" name="restaurant_name" value="Potrefená Husa">
