...
<section>
    <div class="karty">
        <div class="col-auto">
            ...
            <p><strong>Jméno:</strong> {{ $latestUser->user->name }}</p>
            <p><strong>Příjmení:</strong> {{ $latestUser->user->last_name }}</p>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-12">
                    <h2 class="nadpis_match">Lidé kteří si vybrali stejný typ restaurace jako Vy, ale chtějí jinam:
                    </h2>
                ...
                <p class="no-matches-message karta_match"><strong>Je nám líto, ale bohužel jsme nikoho nenašli. Ale
                        nezoufej, máme tě uloženého a třeba se ti za chvíli někdo ozve :D</strong></p>
                @endif
            </div>
        </div>
</section>
